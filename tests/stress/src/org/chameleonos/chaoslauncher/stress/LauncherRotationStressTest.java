...
package org.chameleonos.chaoslauncher.stress;


import org.chameleonos.chaoslauncher.Launcher;
...
/**
 * Run rotation stress test using ChaOSLauncher for 50 iterations.
 */
public class LauncherRotationStressTest extends ActivityInstrumentationTestCase2<Launcher> {
    ...
    private static final String LOG_TAG = "ChaOSLauncherRotationStressTest";
